        ...
        <ul className="timeline timeline-snap-icon timeline-compact timeline-vertical max-w-md lg:max-w-xl mx-auto">
          <li>
            <TimelineEvent
              ...
              company="i4software"
            >
              i4software is a software company that focuses on developing mobile
          ...
          <li>
            ...
            >
              The Purdue Flutter Development Club is a student organization that
              focuses on developing mobile applications using Flutter.
            </TimelineEvent>
            <hr />
          </li>
        </ul>
